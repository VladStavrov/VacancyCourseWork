...
public class ResponseController {
    ...
    public List<ResponseDTO> getAllByCompanyName(@PathVariable String username) {
        return responseService.getAllResponsesByCompanyName(username);
    }
    ...
    public ResponseDTO createResponse(@RequestBody ResponseCreateDTO responseDTO) {
